module.exports = function(grunt) {
    ...
    grunt.initConfig({
        ...
        watch: {
            ...
            tasks: ['default'],
            livereload: {
                files: ['src/css/scss/*','src/emails/*','src/layouts/*'], // grunt templateing not workin g :( <%= watch.files %>,
                options: {
                    livereload: true
                },
            },
        ...
        cdn: {
          options: {
            cdn: 'http://cdn.awtwhite.com/container', // Change this
            flatten: true,
            supportedTypes: 'html'
          },
          dist: {
    ...
    grunt.registerTask('cdnify', ['default','cdn']);
